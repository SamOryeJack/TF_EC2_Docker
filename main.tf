...
resource "null_resource" "name" {
  ...
  provisioner "file" {
    source      = "~/Desktop/dockcred.txt"
    destination = "/home/ec2-user/dockcred.txt"
  }
  ...
  provisioner "file" {
    source      = "build_docker_image_100422.sh"
    destination =  "/home/ec2-user/build_docker_image_100422.sh"
  }

  # set permissions and run the build_docker_image_100422.sh file
  provisioner "remote-exec" {
    inline = [
      "sudo chmod +x /home/ec2-user/build_docker_image_100422.sh",
      "sh /home/ec2-user/build_docker_image_100422.sh",
    ]
  }
